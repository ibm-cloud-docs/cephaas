...
When you log in to your Fusion as a Service deployment for the first time, a welcome modal guides you through the initial setup process. This onboarding flow helps you configure your deployment and understand the next steps for provisioning clusters.
{: shortdesc}
...
The welcome modal appears automatically when you access your deployment for the first time. It provides an overview of your deployment status and guides you to the appropriate next steps.
...
1. In the welcome modal, click **Set cluster quota**.
...
1. In the welcome modal, click **View your clusters**.
