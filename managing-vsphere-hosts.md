...
2. Navigate to **Inventory** > **CephaaS** > **Cluster** > **Host** > **Configure** tab > **Host Connectivity**.
...
1. From the vSphere client screen, navigate to **Inventory** > **CephaaS** > **Cluster** > **Host** > **Configure** tab > **Host Connectivity**.
2. Click **Add Host**.
3. **Add Host** screen is displayed.
4. Enter values in the fields **Host Name**.
5. Click **Add**.
