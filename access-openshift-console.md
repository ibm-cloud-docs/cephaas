...
Open the Red Hat OpenShift console from your Fusion as a Service deployment when you need to continue cluster and workload tasks in Red Hat OpenShift on IBM Cloud Satellite. Understanding when to use Fusion as a Service and when to use the Red Hat OpenShift console helps you work efficiently across both environments.
{: shortdesc}
...
Fusion as a Service and Red Hat OpenShift each manage different aspects of your cluster environment. Understanding this division helps you know where to perform specific tasks.
...
You typically move to the Red Hat OpenShift console after you finish the Fusion as a Service task that prepares the cluster for storage use.
...
A typical workflow might involve moving between Fusion as a Service and Red Hat OpenShift:
...
- [View cluster details](/docs/cephaas?topic=cephaas-view-cluster-storage-status) in Fusion as a Service
