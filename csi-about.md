...
You can find the source code and release information in the [Kubernetes CSI GitHub organization](https://kubernetes-csi.github.io/docs/drivers.html){: external}.
...
| 1.0.1              | 1.0.1             | `registry.k8s.io/sig-storage` | `csi-provisioner: v3.5.0`, `csi-attacher: v4.8.0`, `csi-resizer: v1.4.0`, `csi-node-driver-registrar: v2.8.0`, `csi-snapshotter: v6.2.2`, `snapshot-controller: v6.2.2` |
| 1.0.2              | 1.0.2             | `registry.k8s.io/sig-storage` | `csi-provisioner: v3.5.0`, `csi-attacher: v4.8.0`, `csi-resizer: v1.4.0`, `csi-node-driver-registrar: v2.8.0`, `csi-snapshotter: v6.2.2`, `snapshot-controller: v6.2.2` |
