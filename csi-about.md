...
You can find the source code and release information in the Kubernetes CSI GitHub organization used in CephaaS CSI driver (v1.0.0)
...
| CSI driver version | Helm chart version | Image source                  | Sidecar containers                                                                                                                                                                                                 | Release date    | Release notes     |
|--------------------|--------------------|-------------------------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|------------------|--------------------|
| 1.0.0              | 1.0.0              | `registry.k8s.io/sig-storage` | - `csi-provisioner: v3.5.0`<br>- `csi-attacher: v4.8.0`<br>- `csi-resizer: v1.4.0`<br>- `csi-node-driver-registrar: v2.8.0`<br>- `csi-snapshotter: v6.2.2`<br>- `snapshot-controller: v6.2.2` | Sept. 19, 2025 | Initial version   |
