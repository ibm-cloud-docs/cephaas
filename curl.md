...
The detailed description of the RESTful API for {{site.data.keyword.cephaas_full_notm}} can be found in the [{{site.data.keyword.cephaas_full_notm}} Object Storage API Documentation](https://cloud.ibm.com/docs/apis/object-storage){: external}.
