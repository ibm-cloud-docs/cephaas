...
You can either review your current satellite locations or create a new location. For more information, see [the {{site.data.keyword.cloud_notm}} Creating a new satellite location](/docs/cephaastopic=cephaas-creating-anew-satellite-location).
